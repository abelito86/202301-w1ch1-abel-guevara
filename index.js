...
const eraserAll = document.querySelector("[data-eraser]");
const eraser = document.querySelector("[data-eraser-1]");
const equal = document.querySelector("[data-igual]");
const textBeforeValue = document.querySelector("[data-before-value]");
const textActualValue = document.querySelector("[data-actual-value]");
